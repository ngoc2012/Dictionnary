...
<TITLE>Luclak - Vietnamese dictionary</TITLE>
<script type="text/javascript" src="vime.js"></script>
<style type="text/css">
div.i {background:black; color:white; font:30pt Courier; font-weight:bold}
body {background:black; color:white; font:12pt Palatino}
input.t {background-color:#000000;color:white;font-family:monospace;}
input.b {background-color:#000000;color:white;font:12pt Palatino}
word,wordgroup,gloss,type{display:block;}
</style>
</head>
<body onload="load()">
<div class="i">L u c l a k</div>Vietnamese dictionary<hr/>
<div id="header"></div>
<table>
<tr>
<td><input type="button" value="Lookup" style="width:120px" class="b" onclick="getword(0)"/></td><td><input type="button" value="G" style="width:40px"class="b"onclick="googleSearch()"/></td>
...
<option value="1" selected>En-Vn</option>
